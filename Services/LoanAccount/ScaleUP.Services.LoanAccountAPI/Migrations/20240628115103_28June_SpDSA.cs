...
{
    /// <inheritdoc />
    public partial class _28June_SpDSA : Migration
    {
        /// <inheritdoc />
...
--insert into @leadIds values(304)
...
;WITH LeadData AS (
    ...
    INNER JOIN BusinessLoans bl with(nolock) ON bl.LoanAccountId = l.Id
	...
	group by bl.loan_id,l.AccountCode,l.DisbursalDate,l.CustomerName,l.MobileNo,l.CustomerImage,l.LeadId,at.Id
)
