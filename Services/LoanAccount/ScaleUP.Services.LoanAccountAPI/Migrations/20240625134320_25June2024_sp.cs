...
{
    /// <inheritdoc />
    public partial class _25June2024_sp : Migration
    {
        /// <inheritdoc />
...
CREATE OR ALTER   Proc [dbo].[GetDisbursedLoanDetail]
	...
	Begin
		...
		,b.AccountNumber as borro_bank_acc_num,l.loan_int_amt
		,l.company_id,l.product_id,l.processing_fees_amt,l.net_disbur_amt
		from LoanAccounts a with(nolock) 
		inner join BusinessLoans l with(nolock) on a.Id=l.LoanAccountId
		inner join LoanBankDetails b on b.LoanAccountId=a.Id
		where a.IsActive=1 and a.IsDeleted=0 and a.LeadId=@leadid and b.IsActive=1 and b.IsDeleted=0 and l.IsActive=1 and l.IsDeleted=0
	End
