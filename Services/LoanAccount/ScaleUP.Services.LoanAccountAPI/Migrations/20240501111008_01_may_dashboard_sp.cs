...
{
    /// <inheritdoc />
    public partial class _01_may_dashboard_sp : Migration
    {
        /// <inheritdoc />
...
ALTER   proc [dbo].[GetLoanAccountDashboardDetails] 
	--Declare
	...
	as
	begin
		--insert into @cityName values('Indore')
		...
		--and (l.Created between @FromDate and  @ToDate)
		outer apply
		(
			select	
