...
{
    /// <inheritdoc />
    public partial class _22Jul2024_BusinessLoanLdisbursementdetail : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AddColumn<long>(
                name: "LoanAccountId",
                table: "OfferConfigurationByLoanAccount",
                type: "bigint",
                nullable: false,
                defaultValue: 0L);

            migrationBuilder.CreateTable(
                name: "BusinessLoanDisbursementDetail",
                columns: table => new
                {
                    ...
                    PFDiscount = table.Column<double>(type: "float", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessLoanDisbursementDetail", x => x.Id);
                });
        }
