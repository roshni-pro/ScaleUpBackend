...
{
    /// <inheritdoc />
    public partial class sp_GetScaleUpInvoiceWithScaleUpShare_27_06_2024_UAT : Migration
    {
        /// <inheritdoc />
...
begin
		...
		left Join #tempTrans p on a.InvoiceNo=p.InvoiceNo
		 ...
		 (   
		  ...
		  from ScaleUP_Product_UAT.dbo.ProductNBFCCompany b where b.CompanyId=a.NBFCCompanyId and b.ProductId=a.ProductId
		  and a.TransactionDate between b.AgreementStartDate and b.AgreementEndDate
		  order by b.Id desc
		 ) b 
		 outer apply
		 (
		  Select top 1 c.AnnualInterestRate,c.BounceCharge,c.DelayPenaltyRate from  ScaleUP_Product_UAT.dbo.ProductAnchorCompany c 
