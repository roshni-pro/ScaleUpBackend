...
{
    /// <inheritdoc />
    public partial class _23jul2024_sp : Migration
    {
        /// <inheritdoc />
...
Begin 
	...
	,IsNull(case 
		when b.CompanyIdentificationCode='AYEFIN' then 'AYE Finance' 
		when b.CompanyIdentificationCode='MASFIN' then 'MAS Finance'
		else b.CompanyIdentificationCode
	 end,'') as CompanyIdentificationCode
	 ,IsNull(b.OfferStatus,0) as OfferStatus
	from Leads k with(nolock)
	left join BusinessLoanNBFCUpdate b with(nolock) on b.LeadId=k.Id
