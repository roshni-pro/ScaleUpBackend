...
{
    /// <inheritdoc />
    public partial class _10jul20242 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "BusinessLoanNBFCUpdate",
                columns: table => new
                {
                    ...
                    IsOfferRejected = table.Column<bool>(type: "bit", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessLoanNBFCUpdate", x => x.Id);
                });
        }
