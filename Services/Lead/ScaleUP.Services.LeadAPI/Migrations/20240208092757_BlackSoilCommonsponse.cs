...
{
    /// <inheritdoc />
    public partial class BlackSoilCommonsponse : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlackSoilCommonAPIRequestResponses", x => x.Id);
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommonAPIRequestResponses", x => x.Id);
                });
        }
    }
}
