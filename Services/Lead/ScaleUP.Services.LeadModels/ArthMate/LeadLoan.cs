...
{
    public class LeadLoan : BaseAuditableEntity
    {
        ...
        public double? gst_on_subvention_fees { get; set; }
        public double? cgst_on_subvention_fees { get; set; }
        public double? sgst_on_subvention_fees { get; set; }
        public double? igst_on_subvention_fees { get; set; }
        ...
        public double? gst_on_application_fees { get; set; }
        public double? cgst_on_application_fees { get; set; }
        public double? sgst_on_application_fees { get; set; }
        public double? igst_on_application_fees { get; set; }
