...
namespace ScaleUP.Services.ProductAPI.Migrations
{
    ...
    [Migration("20240125091643_25-Jan_ProductNBFC")]
    partial class _25Jan_ProductNBFC
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScaleUP.Services.ProductModels.Master.NBFCCompanyApi", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("NBFCCompanyApiTypeId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("NBFCCompanyApiTypeId");
            ...
            modelBuilder.Entity("ScaleUP.Services.ProductModels.Master.NBFCCompanyApi", b =>
                {
                    b.HasOne("ScaleUP.Services.ProductModels.Master.NBFCCompanyApiType", "NBFCCompanyApiType")
                        .WithMany()
                        .HasForeignKey("NBFCCompanyApiTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("NBFCCompanyApiType");
                });
            ...
            modelBuilder.Entity("ScaleUP.Services.ProductModels.Master.NBFCSubActivityApi", b =>
                {
                    ...
                    b.HasOne("ScaleUP.Services.ProductModels.Master.NBFCCompanyApi", "NBFCCompanyApis")
                        .WithMany()
