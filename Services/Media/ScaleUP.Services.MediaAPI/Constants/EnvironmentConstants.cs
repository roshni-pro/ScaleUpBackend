namespace ScaleUP.Services.MediaAPI.Constants
{
    internal static class EnvironmentConstants
    {
        ...
        internal static string MediaServiceBaseURL = Environment.GetEnvironmentVariable("MediaServiceBaseURL");
        internal static string MediaServiceLocalBaseURL = Environment.GetEnvironmentVariable("MediaServiceLocalBaseURL");
        
        internal static string Azureconnectionstring = Environment.GetEnvironmentVariable("Azureconnectionstring");
        internal static string AzurecontainerName = Environment.GetEnvironmentVariable("AzurecontainerName");
