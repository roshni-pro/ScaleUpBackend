...
{
    public class BlackSoilLoanAvailed
    {
        public BlackSoilLoanAvailedData data { get; set; }
    }
    public class BlackSoilLoanAvailedData
    {
        ...
        public BlackSoilLoanAvailedIdentifiers identifiers { get; set; }
    }

    public class BlackSoilLoanAvailedIdentifiers
    {
