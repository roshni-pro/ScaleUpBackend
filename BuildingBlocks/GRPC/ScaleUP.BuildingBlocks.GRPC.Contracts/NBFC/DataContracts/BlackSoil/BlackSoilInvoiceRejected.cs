...
{
    public class BlackSoilInvoiceRejected
    {
        public BlackSoilInvoiceRejectedData data {  get; set; } 
    }
    public class BlackSoilInvoiceRejectedData
    {
        ...
        public BlackSoilInvoiceRejectedLoanData loan_data { get; set; }
        public string? topup { get; set; }
        public BlackSoilInvoiceRejectedIdentifiers identifiers { get; set; }
    }

    public class BlackSoilInvoiceRejectedIdentifiers
    {
    ...
    public class BlackSoilInvoiceRejectedLoanData
    {
        public long? id { get; set; }
        public string? update_url { get; set; }
        ...
        public long? current_cashback_amount { get; set; }
        public string? created_at { get; set; }
        public string? updated_at { get; set; }
