...
{
    public class BlackSoilInvoiceApproved
    {
        public BlackSoilInvoiceApprovedData data { get; set; }
        public string? @event { get; set; }
        public string? timestamp { get; set; }
    }
    public class BlackSoilInvoiceApprovedData
    {
        ...
        public BlackSoilInvoiceApprovedLoanData loan_data { get; set; }
        public string? topup { get; set; }
        public BlackSoilInvoiceApprovedIdentifiers identifiers { get; set; }
    }

    public class BlackSoilInvoiceApprovedIdentifiers
    {
    ...
    public class BlackSoilInvoiceApprovedLoanData
    {
        public long? id { get; set; }
        public string? update_url { get; set; }
