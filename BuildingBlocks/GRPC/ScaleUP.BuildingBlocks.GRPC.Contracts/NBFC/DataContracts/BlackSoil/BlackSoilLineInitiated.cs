...
{
    public class BlackSoilLineInitiated
    {
        public BlackSoilLineInitiatedData data {  get; set; }
    }

    public class BlackSoilLineInitiatedData
    {
        ...
        public BlackSoilLineInitiatedIdentifiers identifiers { get; set; }
    }

    public class BlackSoilLineInitiatedIdentifiers
    {
