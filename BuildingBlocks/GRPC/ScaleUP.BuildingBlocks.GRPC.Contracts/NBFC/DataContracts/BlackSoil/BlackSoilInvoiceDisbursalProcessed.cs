...
{
    public class BlackSoilInvoiceDisbursalProcessed
    {
        public BlackSoilInvoiceDisbursalProcessedData data { get; set; }
    }

    public class BlackSoilInvoiceDisbursalProcessedData
    {
        ...
        public BlackSoilInvoiceDisbursalProcessedInvoice invoice { get; set; }
        public long? loan_account { get; set; }
        public BlackSoilInvoiceDisbursalProcessedLoanData loan_data { get; set; }
        public BlackSoilInvoiceDisbursalProcessedIdentifiers identifiers { get; set; }
    }

    public class BlackSoilInvoiceDisbursalProcessedIdentifiers
    {
    ...
    public class BlackSoilInvoiceDisbursalProcessedInvoice
    {
        public long? id { get; set; }
        // public string? update_url { get; set; }
    ...
    public class BlackSoilInvoiceDisbursalProcessedLoanData
    {
        //public long? id { get; set; }
        //public string? update_url { get; set; }
