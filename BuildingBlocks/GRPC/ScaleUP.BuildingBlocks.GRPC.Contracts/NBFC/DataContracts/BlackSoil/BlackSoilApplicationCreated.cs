...
{
    public class BlackSoilApplicationCreated
    {
        public BlackSoilApplicationCreatedData data { get; set; }
        public string @event { get; set; }
        public string timestamp { get; set; }

    }

    public class BlackSoilApplicationCreatedData
    {
        ...
        public BlackSoilApplicationCreatedIdentifier identifiers { get; set; }
    }

    public class BlackSoilApplicationCreatedIdentifier
    {
