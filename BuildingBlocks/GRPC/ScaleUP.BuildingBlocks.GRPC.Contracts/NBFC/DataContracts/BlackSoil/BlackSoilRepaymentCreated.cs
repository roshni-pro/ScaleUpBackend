...
{
    public class BlackSoilRepaymentCreated
    {
        public BlackSoilRepaymentCreatedData data {  get; set; }
    }
    public class BlackSoilRepaymentCreatedData
    {
        ...
        public BlackSoilRepaymentCreatedIdentifiers identifiers { get; set; }
    }

    public class BlackSoilRepaymentCreatedIdentifiers
    {
