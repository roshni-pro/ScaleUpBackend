...
{
    public class BlackSoilRepaymentCredited
    {
        public BlackSoilRepaymentCreditedData data {  get; set; }
    }
    public class BlackSoilRepaymentCreditedData
    {
        ...
        public BlackSoilRepaymentCreditedIdentifiers identifiers { get; set; }
    }

    public class BlackSoilRepaymentCreditedIdentifiers
    {
