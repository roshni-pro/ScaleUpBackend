...
{
    [DataContract]
    public class LoanAccountListDetail
    {
        [DataMember(Order = 1)]
        ...
        [DataMember(Order = 14)]
        public double UtilizeLimit { get; set; }
        [DataMember(Order = 15)]
        public double AvailableCreditLimit { get; set; }
        [DataMember(Order = 16)]
        public double UdharLimit { get; set; }
        [DataMember(Order = 17)]
    ...
    [DataContract]
    public class LoanAccountList
    {
        [DataMember(Order = 1)]
        public List<LoanAccountListDetail> LoanAccountListDetail { get; set; }
        [DataMember(Order = 2)]
